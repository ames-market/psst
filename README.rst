...
Copyright 2007 - present: numerous others credited in :ref:`rst_authors`
...
More detail is provided in the original release notes  and list of publications . The original contributors to AMES have now spread out through several organizations in the electric power industry. In order to facilitate long-term viability and broader use of AMES, this repository has been created to consolidate the development efforts from different organizations.
